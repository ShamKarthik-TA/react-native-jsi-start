...
public class JSIStartModule extends ReactContextBaseJavaModule {
  ...
  public JSIStartModule(ReactApplicationContext reactContext) {
    super(reactContext);
  }
  ...
  public boolean install() {
    try {
      ...
      Log.i(NAME, "Installing JSI Bindings for react-native-jsi-start...");
      mHybridData = initHybrid();
      nativeInstall(jsContext.get(), jsCallInvokerHolder);
      Log.i(NAME, "Successfully installed JSI Bindings for react-native-jsi-start!");

      return true;
    } catch (Exception exception) {
      Log.e(NAME, "Failed to install JSI Bindings for react-native-jsi-start!", exception);
      return false;
    }
  }
